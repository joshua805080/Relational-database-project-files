...
--
-- Name: appointments a_s; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT a_s FOREIGN KEY (service_id) REFERENCES public.services(service_id);


--
-- Name: appointments ac; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT ac FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
